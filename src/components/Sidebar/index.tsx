        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <!-- Menu Item Employees --> */}
              {(userRole === 'Delivery Manager' || userRole === 'Admin') && (
                <li>
                  <NavLink
                    to="/employees"
              ...
              {/* <!-- Menu Item Add Service --> */}
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/addservice' || pathname.includes('addservice')
                }
              >
                {(handleClick, open) => {
                  return (
